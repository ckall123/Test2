...
Training logs are saved in `runs/xarm6_train/`.
...
- `Metrics/VLM_score`: VLM feedback score
- `Metrics/Layout`: object alignment score
- `Metrics/Gripper`: gripper actions
- `Actions/all` and `Actions/gripper`: action histograms
- Sampled images in `runs/xarm6_train/samples/`
