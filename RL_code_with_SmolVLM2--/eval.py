...
def make_env(max_steps: int):
    def _thunk():
        ...
        rewarder = XArmReward(
            table_z=1.0, safe_z_margin=0.03, close_gap_threshold=0.015,
            move_cost_coeff=0.01, violation_penalty=1.0, ee_low_penalty=0.5, step_penalty=0.01)
        ...
        env = VLMRewardWrapper(
            ...
            coeff=0.0,  # 只記錄分數不改變 reward
            model=os.environ.get("OLLAMA_VLM", "qwen2-vl"),
