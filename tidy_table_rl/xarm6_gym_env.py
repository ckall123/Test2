# xarm6_gym_env.py
# ✅ 改寫目標：符合「關節為主」版完整規格 + 整合 Spawner + 修正可開度单位
...
GRIPPER_MAX = 0.8552  # 最大卡爪角度，與 MoveItController 定義一致
...
class XArm6Env(gym.Env):
    ...
    def reset(self, *, seed=None, options=None):
        ...
        self.object_names = load_target_names()[: self.k_objects]

        for _ in range(60):  # ✔️ 推薦抽格更繁
    ...
    def step(self, action: np.ndarray):
        ...
        gripper_pos = open_frac * GRIPPER_MAX  # ✔️ 单位轉換
