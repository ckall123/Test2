...
from tidy_table_rl.sim.camera import TopDownCamera            # 獲取上視角 RGB 觀測
from tidy_table_rl.control.moveit_controller import MoveIt2Controller  # 控制 MoveIt2 的機械手臂與夾爪
from tidy_table_rl.sim.gripper_contact import GripperContact       # 夾爪是否同時接觸物體
from tidy_table_rl.sim.attach_detach import AttachDetachHelper     # 模擬 attach/detach 機制
from tidy_table_rl.spawner import Spawner                   # 隨機生成物品
from tidy_table_rl import reward as R                          # 套件化 reward 設計（align + VLM）
